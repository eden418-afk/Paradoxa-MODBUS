...
class SingleTab(QWidget):
    ...
    def widgets(self):
        ...
        self.addressEntry.setPlaceholderText("0 - ff")
        addressEntryrx = QRegExp("[abcdef0123456789]{2}")
        self.addressEntry.setValidator(QRegExpValidator(addressEntryrx))
        self.addressEntry.textEdited.connect(self.updateSentText)
    ...
    def layouts(self):
        ...
        # RIGHT LAYOUT
        # # address layout
        self.addressLayout.addWidget(QLabel("0x"))
        self.addressLayout.addWidget(self.addressEntry)
        # # form layout
        self.formLayout.addRow("ADDRESS: ", self.addressLayout)
    ...
    def updateSentText(self):
        addressEntryWithZero = f"0{self.addressEntry.text()}"
        ...
        try:
            self.sentEntry.setText(f"{self.addressEntry.text() if len(self.addressEntry.text()) == 2 else addressEntryWithZero}"
            ...
            print("Error in single tab updateSentText()")
